      ...
      <div className="container m-auto px-6 text-gray-600 md:px-12 xl:px-6">
          <div className="space-y-6 md:space-y-0 md:flex md:gap-6 lg:items-center lg:gap-12">
            <div className="md:5/12 lg:w-5/12">
              <img src="../src/assets/juicy-girl-and-guy-preparing-start-up-rocket-to-launch-with-ideas.gif" alt="image" loading="lazy" className="rounded-lg"/>
            </div>
            <div className="md:7/12 lg:w-6/12">
              ...
              <a href="/About" className="border-b-2 border-black py-1 mt-16 text-black transition ease-in-out hover:bg-white">Saiba Mais</a>
            </div>
          </div>
      </div>
    </div>
